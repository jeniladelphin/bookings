...
declare module "imapflow" {
    ...
    class ImapFlow extends EventEmitter {
         ...
         * @param [options.statusQuery.messages] - if `true` request count of messages
         * @param [options.statusQuery.recent] - if `true` request count of messages with \\Recent tag
         * @param [options.statusQuery.uidNext] - if `true` request predicted next UID
         * @param [options.statusQuery.uidValidity] - if `true` request mailbox `UIDVALIDITY` value
         * @param [options.statusQuery.unseen] - if `true` request count of unseen messages
         * @param [options.statusQuery.highestModseq] - if `true` request last known modseq value
         ...
         * @param [options.specialUseHints.sent] - Path to "Sent Mail" folder
         * @param [options.specialUseHints.trash] - Path to "Trash" folder
         * @param [options.specialUseHints.junk] - Path to "Junk Mail" folder
         * @param [options.specialUseHints.drafts] - Path to "Drafts" folder
